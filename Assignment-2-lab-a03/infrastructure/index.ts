...
const registry = new containerregistry.Registry(`cst8918a03dewa0117ACR`, {
...
const image = new docker.Image(`${prefixName}-image`, {
  ...
  build: {
    dockerfile: "D:\\Algonquin studies\\Cloud\\DevOps IaC\\Lab 3\\Assignment-2-lab-a03\\infrastructure\\DockerFile",
    context: appPath,
